...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'data-v-8514c55c'])
Z([3,'avatar-container data-v-8514c55c'])
Z([3,'cu-avatar xl round data-v-8514c55c'])
Z([[2,'+'],[[2,'+'],[1,'background-image:'],[[2,'+'],[[2,'+'],[1,'url('],[[6],[[7],[3,'userInfo']],[3,'avatarUrl']]],[1,')']]],[1,';']])
Z([3,'nickname data-v-8514c55c'])
Z([a,[[6],[[7],[3,'userInfo']],[3,'nickName']]])
Z([3,'items data-v-8514c55c'])
Z([3,'cu-list menu sm-border card-menu data-v-8514c55c'])
Z([3,'__e'])
Z([3,'cu-item arrow data-v-8514c55c'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'toMyCollection']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'content data-v-8514c55c'])
Z([3,'text-grey data-v-8514c55c'])
Z([3,'我的收藏'])
Z(z[8])
Z(z[9])
...
var bMC=_v()
_(eLC,bMC)
if(_oz(z,108,lIC,oHC,gg)){bMC.wxVkey=1
var cRC=_mz(z,'input',['bindinput',109,'data-event-opts',1,'password',2,'placeholder',3,'type',4,'value',5],[],lIC,oHC,gg)
_(bMC,cRC)
}
var oNC=_v()
_(eLC,oNC)
if(_oz(z,115,lIC,oHC,gg)){oNC.wxVkey=1
var hSC=_mz(z,'input',['bindinput',116,'data-event-opts',1,'password',2,'placeholder',3,'value',4],[],lIC,oHC,gg)
_(oNC,hSC)
}
var xOC=_v()
_(eLC,xOC)
if(_oz(z,121,lIC,oHC,gg)){xOC.wxVkey=1
var oTC=_mz(z,'input',['bindinput',122,'data-event-opts',1,'password',2,'placeholder',3,'type',4,'value',5],[],lIC,oHC,gg)
_(xOC,oTC)
}
var oPC=_v()
_(eLC,oPC)
if(_oz(z,128,lIC,oHC,gg)){oPC.wxVkey=1
var cUC=_mz(z,'input',['bindinput',129,'data-event-opts',1,'password',2,'placeholder',3,'type',4,'value',5],[],lIC,oHC,gg)
_(oPC,cUC)
}
var fQC=_v()
_(eLC,fQC)
if(_oz(z,135,lIC,oHC,gg)){fQC.wxVkey=1
var oVC=_mz(z,'input',['bindinput',136,'data-event-opts',1,'password',2,'placeholder',3,'type',4,'value',5],[],lIC,oHC,gg)
_(fQC,oVC)
}
bMC.wxXCkey=1
oNC.wxXCkey=1
...
var aXC=_mz(z,'view',['bindtap',143,'class',1,'data-event-opts',2,'style',3],[],e,s,gg)
var tYC=_oz(z,147,e,s,gg)
_(aXC,tYC)
_(lWC,aXC)
var eZC=_mz(z,'view',['bindtap',148,'class',1,'data-event-opts',2,'style',3],[],e,s,gg)
...
var oJ=_v()
_(oB,oJ)
if(_oz(z,153,e,s,gg)){oJ.wxVkey=1
var o2C=_n('slot')
_(oJ,o2C)
}
xC.wxXCkey=1
...
__wxAppCode__['pages/my/my/my.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n.",[1],"avatar-container.",[1],"data-v-8514c55c { padding: 50px 0; background: #fff; text-align: center; margin-bottom: 30px; }\n.",[1],"avatar-container .",[1],"nickname.",[1],"data-v-8514c55c { margin-top: 10px; }\n.",[1],"items.",[1],"data-v-8514c55c { padding-bottom: 70px; }\n",],undefined,{path:"./pages/my/my/my.wxss"});    
